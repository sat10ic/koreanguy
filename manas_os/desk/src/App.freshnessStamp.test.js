...
import { computeFreshnessBanner, relativeDayLabel } from "./App.jsx";
...
describe("computeFreshnessBanner", () => {
  ...
  it("falls back to 'unknown' for missing build_sha and data_as_of", () => {
    const result = computeFreshnessBanner({ next_update_hint: "market closed — data through 2026-07-10" }, null, "2026-07-11");
    expect(result.text).toBe(
