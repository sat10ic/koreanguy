...
- 2026-07-18 order-size/tick-data purchase decision: DEFERRED behind evidence. Free proxy exists (bhavcopy volume/num_trades = avg trade size, already in activity v2); Q4 factor-health must show the FREE factor's IC at swing horizon first -- only then does a paid tick/TBT feed have a baseline to beat. Footprint/delta methodology judged real but intraday-execution horizon, not EOD swing selection; possible future fit = P4 live strong-start confirm leg.
