# titan-setup-10 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 10.jpeg |
| symbol | DATAMATICS GLOBAL / FACT LTD context |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN curriculum #10. EXIT BELOW 20 MA CLOSE; top strip DATAMATICS-style, daily FACT LTD label |

JSON: `entries/json/titan-setup-10.json`
...
- TITAN checklist full
- Symbol: DATAMATICS GLOBAL / FACT LTD context
- Outcome: 58% UP IN 1 MONTH

## volume_signature
```
mid footprints → dry at pivot → expansion
```

## unlabeled_detection_spec
**Family:** `titan_multi_tf_coil`
**Must-see:** trend; footprint; tight narrow pivot; vol dry-up; weekly ~10w anchor
