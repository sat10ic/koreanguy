# titan-setup-14 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 14.jpeg |
| symbol | JBM AUTO LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN curriculum #14. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-14.json`
...
- Symbol: JBM AUTO LTD
- Outcome: 85% UP IN LESS THAN A MONTH
