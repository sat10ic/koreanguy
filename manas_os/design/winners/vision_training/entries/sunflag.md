...
| field | value |
|-------|--------|
| source_file | Sunflag.png |
| symbol | SUNFLAG IRON AND STEEL CO · 1D |
| family | `long_dry_base_break` |
| status | **gold** |
| nuance | +77.58%/95d; rest 99d; BF16; LF 800% in 1 month |

JSON: `entries/json/sunflag.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.68]
- **decision_moment:** Leave of 99d shelf
...
- Impulse: +77.58% / 65b / 95d, Vol 98.89M
- Rest: 65b / 99d, Vol 42.53M
- BF: 16 · LF: 800% in 1 months
