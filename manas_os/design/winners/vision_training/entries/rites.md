...
| field | value |
|-------|--------|
| source_file | Rites.png |
| symbol | RITES LTD · 1D |
| family | `long_dry_base_break` |
| status | **gold** |
| nuance | +52%/62d; rest 127d; BF20; LF 300%/14d |

JSON: `entries/json/rites.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.72]
- **decision_moment:** Leave of 127d shelf
...
- Impulse: +52.00% / 43b / 62d, Vol 249.66M
- Rest: 86b / 127d, Vol 209.31M
- BF: 20 · LF: 300% in 14 days

## volume_signature
```
impulse → long dry → expansion
```
