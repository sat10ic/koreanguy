# titan-setup-30 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 30.jpeg |
| symbol | TD POWER SYSTEMS LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #30. Near-duplicate of td-power.jpg; EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-30.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.55]
- **decision_moment:** Daily tight pivot dry + weekly 10w anchor
...
- 65% UP IN JUST OVER 3 MONTHS

## volume_signature
```
footprints -> dry -> expansion
```

## unlabeled_detection_spec
**Family:** `titan_multi_tf_coil`
**Must-see:** TITAN pure geometry
