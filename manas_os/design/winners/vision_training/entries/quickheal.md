...
| field | value |
|-------|--------|
| source_file | QuickHeal.png |
| symbol | QUICK HEAL TECH LTD · 1D |
| family | `long_dry_base_break` |
| status | **gold** |
| nuance | +39.71%/8d; rest 59d; Delayed EP; BF51; LF 500%/7d & 500%/20d |

JSON: `entries/json/quickheal.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.62]
- **decision_moment:** Delayed EP leave after 59d dry rest
...
- Impulse: +39.71% / 5b / 8d, Vol 19.33M
- Rest: 38b / 59d, Vol 10.15M
- BF: 51 · Delayed EP · LF: 500% in 7 Days and 500% in 20 Days

## volume_signature
```
impulse HVY → dry → expansion
```
