# titan-setup-24 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 24.jpeg |
| symbol | RAILTEL CORP OF IND LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #24. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-24.json`
