# titan-setup-19 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 19.jpeg |
| symbol | KPIT TECHNOLOGIES LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #19. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-19.json`
