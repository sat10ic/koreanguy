# titan-setup-26 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 26.jpeg |
| symbol | SOM DIST & BREW LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #26. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-26.json`
