# titan-setup-25 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 25.jpeg |
| symbol | RATTANINDIA ENT LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #25. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-25.json`
