# titan-setup-17 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 17.jpeg |
| symbol | JINDAL STAINLESS LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #17. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-17.json`
