# titan-setup-5 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 5.jpeg |
| symbol | ARVIND LTD · 1W+1D |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | Arvind TITAN; 54% UP MOVE; EXIT BELOW 20 MA; weekly long anchor climb |

JSON: `entries/json/titan-setup-5.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.55]
- **decision_moment:** Daily tight pivot dry + weekly 10w hug
...
- TITAN full on Arvind
- 54% UP MOVE
- EXIT BELOW 20 MA CLOSE

## volume_signature
```
footprint Nov → dry → expansion
```
