# titan-setup-18 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 18.jpeg |
| symbol | KPI GREEN ENERGY LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #18. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-18.json`
