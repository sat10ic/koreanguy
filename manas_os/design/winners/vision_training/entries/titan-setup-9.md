# titan-setup-9 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 9.jpeg |
| symbol | DATA PATTERNS INDIA LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN curriculum #9. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-9.json`
