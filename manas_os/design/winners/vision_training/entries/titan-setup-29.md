# titan-setup-29 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 29.jpeg |
| symbol | SJVN LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #29. Near-duplicate of sjvn.jpg; EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-29.json`
