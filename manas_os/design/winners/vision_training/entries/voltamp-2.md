...
| field | value |
|-------|--------|
| source_file | Voltamp 2.png |
| symbol | VOLTAMP TRANSFORMERS LTD · 1D |
| family | `long_dry_base_break` |
| status | **gold** |
| nuance | +79.47%/92d; rest 97d; BF34; LF 300%/90d |

JSON: `entries/json/voltamp-2.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.68]
- **decision_moment:** Leave of 97d shelf
...
- Impulse: +79.47% / 64b / 92d, Vol 2.46M
- Rest: 65b / 97d, Vol 3.23M
- BF: 34 · LF: 300% in 90 Days
