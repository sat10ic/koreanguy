# titan-setup-22 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 22.jpeg |
| symbol | PARAG MILK FOODS LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #22. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-22.json`
