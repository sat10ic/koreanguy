...
| field | value |
|-------|--------|
| source_file | Zentec.jpg |
| symbol | ZEN TECHNOLOGIES LTD · 1W+1D |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | Same TITAN Zen lifecycle as Titan Setup 1; 176% UP IN 3 MONTHS; EXIT BELOW 20 MA |

JSON: `entries/json/zentec-jpg.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.55]
- **decision_moment:** Daily narrow pivot dry + weekly 10w anchor
...
- TITAN full
- 176% UP IN 3 MONTHS
- EXIT BELOW 20 MA CLOSE

## volume_signature
```
footprints → dry → rocket
```
...
## transfer_rules
- Duplicate teaching of titan-setup-1 on Zen; keep both files mapped.
