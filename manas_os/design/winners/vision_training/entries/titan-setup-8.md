# titan-setup-8 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 8.jpeg |
| symbol | COCHIN SHIPYARD LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN curriculum #8. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-8.json`
