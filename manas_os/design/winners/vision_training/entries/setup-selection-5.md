# setup-selection-5 — GOLD v2

| field | value |
|-------|--------|
| source_file | Setup Selection 5.jpg |
| symbol | HSG & URBAN DEV CORPN LTD · 1W+1D |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | Setup Selection #5 TITAN selection-state. Hudco weekly repair then anchor |

JSON: `entries/json/setup-selection-5.json`
...
- TITAN checklist on HSG & URBAN DEV CORPN LTD
