# titan-setup-7 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 7.jpeg |
| symbol | CENTRAL DEPO SER (I) LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN curriculum #7. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-7.json`
...
- Symbol: CENTRAL DEPO SER (I) LTD
- Outcome labels: 107% UP IN 3 MONTHS
