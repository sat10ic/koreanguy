...
| field | value |
|-------|--------|
| source_file | PNB Giltz.png |
| symbol | PNB GILTS LTD · 1D |
| family | `long_dry_base_break` |
| status | **gold** |
| nuance | +41.36%/11d; rest 90d; dual entries; BF20&34; LF 300%/11d & 300%/17d |

JSON: `entries/json/pnb-giltz.json`

## pre_breakout_crop
- **crop_x:** [0.00, 0.68]
- **decision_moment:** Leave after 90d dry base
...
- Impulse: +41.36% / 7b / 11d, Vol 23.72M
- Rest: 59b / 90d, Vol 29.91M
- BF: 20 and 34 · LF: 300% in 11 Days and 300% in 17 Days

## volume_signature
```
spike HVY → desert → expansion
```
