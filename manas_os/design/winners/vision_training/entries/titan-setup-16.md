# titan-setup-16 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 16.jpeg |
| symbol | JIO FIN SERVICES LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #16. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-16.json`
