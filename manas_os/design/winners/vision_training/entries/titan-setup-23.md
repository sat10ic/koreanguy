# titan-setup-23 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 23.jpeg |
| symbol | PCBL CHEMICAL LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #23. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-23.json`
