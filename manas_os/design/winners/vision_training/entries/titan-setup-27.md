# titan-setup-27 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 27.jpeg |
| symbol | SHAILY ENG PLASTICS LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #27. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-27.json`
