# titan-setup-20 — GOLD v2

| field | value |
|-------|--------|
| source_file | Titan Setup 20.jpeg |
| symbol | NLC INDIA LTD |
| family | `titan_multi_tf_coil` |
| status | **gold** |
| nuance | TITAN #20. EXIT BELOW 20 MA CLOSE |

JSON: `entries/json/titan-setup-20.json`
